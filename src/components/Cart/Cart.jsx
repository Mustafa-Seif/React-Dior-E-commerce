  ...
  <div className="row d-flex justify-content-center align-items-center h-100">
    <div className="col-10">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h3 className="fw-normal mb-0 text-black fw-bold">Shopping Cart</h3>
        <div>
        ...
        <div className="card-body p-4">
          <div className="row d-flex justify-content-between align-items-center">
            ...
            <div className="col-md-3 col-lg-3 col-xl-3">
              ...
              <p><span className="text-muted">{pro.category}</span></p>
            </div>
          ...
          <i className="fas fa-trash fa-lg text-danger" onClick={()=>handleClose(pro)}></i>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <NavLink to="/checkout" className="btn btn-danger btn-block btn-lg">
        Proceed to Checkout
          </NavLink>
        </div>
      </div>
